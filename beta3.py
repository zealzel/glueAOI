...
def parse_image(outdir, image_path=None, show=False):
    if not image_path:
    ...
    # cv2.imwrite(f"{outdir}/{imagename}.jpg", cropped_image, compression_params)
...
if __name__ == "__main__":
    ...
    # parse_image(outdir, image_path)
    #
    # output.csv format:
    # sn, w1,w2,w3
    # imagename, width_average_real[0], width_average_real[1], width_average_real[2]
    # ...
    #
    imagepaths = [
    ...
    for image_path in imagepaths:
        parse_image(outdir, image_path, show)
